          ...
          function HEX3Aanonymous_10260048(ev_10260050) {
              function wrapper_10260051() {
                ...
                framePtr = F;
                  ...
                  F.line = 74;
                  failed_assert_impl_102680(makeNimstrLit("C:\\Users\\syste\\.nimble\\pkgs\\karax-1.1.2\\karax\\karax.nim(74, 10) `action != nil` "));
                  }
...
function to_dom_10300154(n_10300156, use_attached_node_10300157, kxi_10300158) {
  ...
  BeforeRet: do {
    ...
    F.line = 176;
    failed_assert_impl_102680(makeNimstrLit("C:\\Users\\syste\\.nimble\\pkgs\\karax-1.1.2\\karax\\karax.nim(176, 12) `result != nil` "));
    }
    ...
    F.line = 183;
    failed_assert_impl_102680(makeNimstrLit("C:\\Users\\syste\\.nimble\\pkgs\\karax-1.1.2\\karax\\karax.nim(183, 12) `x.renderImpl != nil` "));
    }
    ...
    if (!(!((x_10370022.expanded == null)))) {
    F.line = 187;
    failed_assert_impl_102680(makeNimstrLit("C:\\Users\\syste\\.nimble\\pkgs\\karax-1.1.2\\karax\\karax.nim(187, 12) `x.expanded != nil` "));
    }
...
function diff_10600215(new_node_10600217, old_node_10600218, parent_10600219, current_10600220, kxi_10600221) {
  ...
  BeforeRet: do {
    ...
    case 2:
      ...
      F.line = 487;
      failed_assert_impl_102680(makeNimstrLit("C:\\Users\\syste\\.nimble\\pkgs\\karax-1.1.2\\karax\\karax.nim(487, 12) `oldNode.kind == newNode.kind` "));
      }
    ...
    case 4:
      if (true) {
      F.line = 529;
      failed_assert_impl_102680(makeNimstrLit("C:\\Users\\syste\\.nimble\\pkgs\\karax-1.1.2\\karax\\karax.nim(529, 26) `false` eq returned usenewNode"));
      }
...
function move_dom_10560047(dest_10560049, src_10560050) {
  ...
  framePtr = F;
    ...
    F.line = 390;
    failed_assert_impl_102680(makeNimstrLit("C:\\Users\\syste\\.nimble\\pkgs\\karax-1.1.2\\karax\\karax.nim(390, 10) `dest.len == src.len` "));
    }
      ...
      L5: do {
        F.line = 107;
          ...
          if (!(i_10830224 < kxi_10575224.patchLenV)) break L6;
            ...
            F.line = 429;
            failed_assert_impl_102680(makeNimstrLit("C:\\Users\\syste\\.nimble\\pkgs\\karax-1.1.2\\karax\\karax.nim(429, 12) `p.newChild.dom != nil` "));
            }
...
function dodraw_10715262(kxi_10715264) {
  ...
  BeforeRet: do {
    ...
    replace_by_id_10465074(kxi_10715264.rootId, asdom_10715285);
      ...
      F.line = 644;
      failed_assert_impl_102680(makeNimstrLit("C:\\Users\\syste\\.nimble\\pkgs\\karax-1.1.2\\karax\\karax.nim(644, 14) `same(kxi.currentTree, document.getElementById(kxi.rootId))` "));
      }
    ...
    if (!(same_10450072(kxi_10715264.currentTree, document.getElementById(kxi_10715264.rootId), 0))) {
    F.line = 657;
    failed_assert_impl_102680(makeNimstrLit("C:\\Users\\syste\\.nimble\\pkgs\\karax-1.1.2\\karax\\karax.nim(657, 12) `same(kxi.currentTree, document.getElementById(kxi.rootId))` "));
    }
...
function create_dom_10826014() {
  ...
  framePtr = F;
    F.line = 4;
    F.line = 4;
    var tmp_10826053 = tree_9830445(21, []);
    F.line = 4;
